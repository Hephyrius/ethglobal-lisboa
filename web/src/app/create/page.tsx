      ...
      <header>
        ...
        {track === null ? (
          <ol className="mt-5 grid gap-4 sm:grid-cols-2">
            <TrackCard index={1} title="Deploy a Scipio Agent" onSelect={() => setTrack('agent')}>
            ...
            <TrackCard
              index={2}
              title="Deploy a standard mandate"
          ...
          <ChosenTrack
            title={track === 'agent' ? 'Deploy a Scipio Agent' : 'Deploy a standard mandate'}
